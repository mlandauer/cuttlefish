class Types::App < Types::Base::Object
  ...
  field :smtp_server, Types::SmtpServer, null: false, description: "Details needed to send email to Cuttlefish for this app"
  ...
  field :dkim_dns_record, Types::DkimDnsRecord, null: false, description: "Information about this app's DKIM DNS record"
  ...
  field :permissions, Types::AppPermissions, null: false, description: "Permissions for current admin for accessing and editing this App" do
